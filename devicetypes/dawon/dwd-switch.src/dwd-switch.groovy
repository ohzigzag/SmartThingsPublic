...
metadata {
    definition(name: "DWD Switch", namespace: "DAWON", author: "DAWON", ocfDeviceType: "oic.d.switch", mnmn: "SmartThings", vid: "generic-switch") {
        capability "Actuator"
        ...
        fingerprint profileId: "0104", deviceId: "0103", endpoint: "01", inClusters: "0006, 0000, 0003", outClusters: "0019", manufacturer: "", model: "", deviceJoinName: "스위치 1"
        fingerprint profileId: "0104", deviceId: "0103", endpoint: "02", inClusters: "0006, 0000, 0003", manufacturer: "", model: "", deviceJoinName: "스위치 2"
        fingerprint profileId: "0104", deviceId: "0103", endpoint: "03", inClusters: "0006, 0000, 0003", manufacturer: "", model: "", deviceJoinName: "스위치 3"
        
        fingerprint profileId: "0104", deviceId: "0103", endpoint: "01", inClusters: "0006, 0000, 0003", manufacturer: "", model: "", deviceJoinName: "스위치 1"
        fingerprint profileId: "0104", deviceId: "0103", endpoint: "02", inClusters: "0006, 0000, 0003", manufacturer: "", model: "", deviceJoinName: "스위치 2"
        fingerprint profileId: "0104", deviceId: "0103", endpoint: "03", inClusters: "0006, 0000, 0003", manufacturer: "", model: "", deviceJoinName: "스위치 3"
    }
    // simulator metadata
...
private void createChildDevices() {
	if (state.ch != 1) {
    	for (i in 2..state.ch) {
        	addChildDevice("DWD Child Switch", "${device.deviceNetworkId}:0${i}", device.hubId,
